...
from tools.proton_mail import DEFINITIONS as _pmd, HANDLERS as _pmh
...
TOOL_DEFINITIONS: list[dict] = _hd + _bd + _ad + _nd + _scd + _aud + _pd + _rd + _msd + _hld + _gmd + _cld + _scrd + _ctd + _mid + _mntd + _twd + _sld + _ssd + _pmd + _eed + _mtd + _vd + _sd
...
TOOL_HANDLERS: dict[str, callable] = {
    **_vh, **_hh, **_sh, **_bh, **_ah, **_nh, **_sch, **_auh, **_ph, **_rh, **_msh, **_hlh, **_gmh, **_clh, **_scrh, **_cth, **_mih, **_mnth, **_twh, **_slh, **_ssh, **_pmh, **_eeh, **_mth,
}
